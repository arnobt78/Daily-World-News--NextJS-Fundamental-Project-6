    ...
    <div className="min-h-screen w-full bg-gradient-to-r from-[#b88efc] to-[#6877f4]">
      <div className="max-w-9xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        ...
        <main className="py-12 max-w-3xl">
          <h1 className="font-bebas text-4xl sm:text-5xl text-white tracking-wider mb-8">
            About This Project
          </h1>
          <div className="space-y-6 font-comfortaa text-white/90 leading-relaxed">
            <p>
              This is an educational news app built with Next.js, React, and the
              GNews API. It demonstrates modern web development patterns for
              beginners.
            </p>
            <h2 className="font-bebas text-2xl text-white mt-8 mb-4">
              Features
            </h2>
            <ul className="list-disc list-inside space-y-2 text-white/80">
              <li>Top headlines by category (general, world, technology, etc.)</li>
            ...
            <div className="pt-8">
              <Link
                href="/"
                className="inline-block py-3 px-6 bg-white/20 hover:bg-white/30 rounded-xl text-white font-comfortaa transition-colors"
              >
                Back to Home
              </Link>
            </div>
