/**
 * AboutPage - Static content: project description, features, tech stack, GNews API info.
 * Server component (no hooks). Same layout as other pages: header, main, footer.
 */
  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      <div className="max-w-9xl mx-auto w-full flex flex-col flex-1">
        ...
        <main className="py-8 px-2 sm:px-4 flex-1">
          <h1 className="font-playfair text-2xl sm:text-3xl text-white/80 tracking-wider mb-8">
            About This Project
          </h1>
          <div className="space-y-6 font-outfit text-sm sm:text-base md:text-lg text-white/90 leading-relaxed">
            ...
            <h2 className="font-playfair text-xl sm:text-2xl md:text-3xl text-white/80 mt-8 mb-4">
              Features
            </h2>
